...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="text" value="${bookTypeVo.typeName}" disabled="disabled" lay-verify="required" autocomplete="off"
               class="layui-input">
    </div>
</div>
<div class="layui-form-item">
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="text" value="${bookTypeVo.typePlace}" disabled="disabled" lay-verify="required" autocomplete="off"
               class="layui-input">
    </div>
</div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="text" value="《${bookTypeVo.bookName}》" disabled="disabled" lay-verify="required" autocomplete="off"
               class="layui-input">
    </div>
</div>
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="text" name="authorName" value="${bookTypeVo.bookAuthorName}" disabled="disabled"
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="text" value="${bookTypeVo.bookPress}" disabled="disabled" name="press" lay-verify="required"
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="date" name="publishDate" value="${bookTypeVo.bookPublishDate}" disabled="disabled"
               placeholder="请输入图书出版日期" class="layui-input">
    </div>
</div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        ...
        <c:if test="${bookTypeVo.bookStatus==1}">
            <input type="text" value="在馆" disabled="disabled" name="press" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </c:if>
        <c:if test="${bookTypeVo.bookStatus==2}">
            <input type="text" value="借出" disabled="disabled" name="press" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </c:if>
    ...
    <div class="modal-body">
        <form id="new_form" class="layui-form" action="/borrow/newBorrow/${bookTypeVo.bookId}">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="phone" lay-verify="required" id="phone" onkeyup="checkPhone(this.value)"
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    ...
                    <input type="submit" class="layui-btn" lay-submit="" lay-filter="demo1" value="确认"
